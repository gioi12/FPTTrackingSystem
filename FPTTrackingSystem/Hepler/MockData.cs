            ...
            new Account
            {
                ...
                User =
                    new User
                    {
                        ...
                        Gender = true,
                        Mail = "user1@fpt.edu.vn",
                        Phone = "0909123456",
                        MajorId = 1,
                        CampusId = 1,
                        CapstoneProject = "Capstone Project 1",
                        Address = "Hà Nội",
                        StatusId = "ACTIVE"
                    }
            },
